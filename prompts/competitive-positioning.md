...
Create a competitive positioning brief for the specified competitor in the context of a specific customer opportunity. Include:
...
Reference competition notes and customer context from the vault. If vault data is thin on a topic, flag it as an area to research.
